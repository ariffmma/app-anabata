...
import 'package:blogapp/chat/data/local_database/message_table.dart';
import 'package:blogapp/chat/data/local_database/user_table.dart';
import 'package:blogapp/chat/data/models/chat.dart';
import 'package:blogapp/chat/data/models/message.dart';
...
class DBProvider {
  ...
  Future _open() async {
    ...
    String path = join(documentsDirectory.path, "anabatachat.db");
